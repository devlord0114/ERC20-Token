...
contract lockToken is owned{
    ...
    */
    ...
    function withdrawTokenbyVote(uint256 _id) public onlyOwner {
        
        Token(lockedToken[_id].tokenAddress).transfer(lockedToken[_id].withdrawalAddress, lockedToken[_id].tokenAmount);
