...
SABER is built upon the fundamentals of Buyback and increasing the investor's value
...
contract Saber is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x54FdD1E15aD21434163417005193Fea51E7B02f6); // Marketing Address
    ...
    function _transfer(
        ...
        if(_paused && from != owner() && to != owner()){
            require(from != uniswapV2Pair && to != uniswapV2Pair, "Exchange is paused !");
        }
