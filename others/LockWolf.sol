...
contract LockWolf is owned{
    ...
    */
    ...
    function recoverTokenbyVote(uint256 _id) public onlyOwner {
    ...
    function approve(address _tokenAddress, address _walletAddress, uint256 _amount) public onlyOwner{
       Token(_tokenAddress).approve(_walletAddress, _amount); 
    } 
